...
*=========================================================================*
  ...
  *if (_rc == 601) | (`overwrite_files') {
    ...
    *---------------------------------------------------------------------------
	...
	save "$temp_dir\PISA_2003.dta", replace
...
use "$temp_dir\PISA_2003.dta", replace
    ...
    *<_idgrade_>
	gen idgrade = st01q01 if !inlist(st01q01,97,98,99)
    ...
    *<_urban_>
    recode sc01q01 (1 = 0 "Rural") (2/6 = 1 "Urban") (7 = -97) (8 = -98) (9 = -99), gen(urban)
    ...
    *<_male_>
    recode st03q01 (2 = 1 "Male") (1 = 0 "Female"), gen(male)
	replace male = -99 if male == 9
	replace male = -98 if male == 8
	label var male "Learner gender is male/female"
    *</_male_>
	
	*<_native_>
    recode immig (1 = 1 "N") (2 = 3 "SG") (3 = 2 "FG") (9 = -99), gen(native)
	label define native 1 "N" 2 "SG" 3 "FG", modify
    ...
    *---------------------------------------------------------------------------
	...
	save "$output_dir/WLD_2003_PISA_v01_M_wrk_A_GLAD.dta", replace
